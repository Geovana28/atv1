...
public class Planeta {
    public static void main(String[] args) {
        try (Scanner entrada = new Scanner(System.in)) {
            ...
            double gravidade;
            switch (planeta) {
                case 1: gravidade = 3.7; break;   
                case 2: gravidade = 8.8; break;   
                case 3: gravidade = 9.8; break;    
                case 4: gravidade = 3.8; break;   
                case 5: gravidade = 26.4; break;  
                case 6: gravidade = 11.5; break;  
                case 7: gravidade = 9.3; break;   
                case 8: gravidade = 12.2; break;   
                case 9: gravidade = 0.6; break;    
                default:
