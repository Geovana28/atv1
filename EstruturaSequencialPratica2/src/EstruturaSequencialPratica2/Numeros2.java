        ...
        try (Scanner entrada = new Scanner(System.in)) {
            ...
            switch (opcao) {
                case 1: 
                    ...
                    System.out.println("A soma dos números é: " + resultado); break;
                case 2: 
                    resultado = numero1 * numero2;
                    System.out.println("A multiplicação dos números é: " + resultado); break;
                case 3:
                    if (numero1 > numero2) {
                        resultado = numero1 - numero2;
                    ...
                    System.out.println("A subtração do maior pelo menor é: " + resultado); break;
                case 4: 
                    if (numero2 != 0) {
                        resultado = numero1 / numero2;
